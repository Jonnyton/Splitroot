...
Task arrives
    ...
    |   |-- Unreal Archon RTS/FPS factory? ----------> unreal-archon-game-factory
    |   |-- See/screenshot the SPLITROOT canary? ----> unreal-canary-playtest
...
| Orient | external-research-implications | Turn outside repos, papers, and projects into Workflow implications and plans |
...
| Build | unreal-archon-game-factory | Build this Unreal Archon RTS/FPS reusable game-factory canary |
| Verify | unreal-canary-playtest | Launch the SPLITROOT canary with rendering, capture screenshots, evaluate visually (companion to the headless smoke) |
...
| Ops | loop-uptime-maintenance | Handle community loop outages that cannot self-heal through the loop |
